...
HD_PWD='C:/Users/lenovo/Desktop/term6/CAD/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sample.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sample.tcl -notrace

...
HD_PWD='C:/Users/lenovo/Desktop/term6/CAD/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sample.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sample.tcl

...
REM
REM Generated by Vivado on Wed Apr 05 23:46:22 +0330 2023
...
echo "xvhdl --incr --relax -prj mux_2to1_tb_vhdl.prj"
call xvhdl  --incr --relax -prj mux_2to1_tb_vhdl.prj -log xvhdl.log
